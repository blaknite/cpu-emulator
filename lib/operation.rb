class Operation
  ...
  def initialize(computer, steps)
    @computer = computer
    @steps = Array.new(steps){ nil }
  end
  ...
  def complete?
    @computer.ic.value >= @steps.length
  end
end
...
class Operation::LD < Operation
  def initialize(computer)
    ...
    @steps[4] = -> { @computer.pc.value += 1 }
    @steps[5] = -> { @operand += @computer.ram[@computer.pc.value].value }
    @steps[6] = -> { @computer.pc.value += 1 }
    @steps[7] = -> { @computer.a.value = @computer.ram[@operand].value }
  end
end
...
class Operation::ST < Operation
  def initialize(computer)
    ...
    @steps[5] = -> { @operand += @computer.ram[@computer.pc.value].value }
    @steps[6] = -> { @computer.pc.value += 1 }
    @steps[7] = -> { @computer.ram[@operand].value = @computer.a.value }
  end
end
...
class Operation::NOR < Operation
  def initialize(computer)
    ...
    @steps[6] = -> {
      @computer.pc.value += 1
      @computer.b.value = @computer.a.value
    }
    @steps[7] = -> {
      result = ~(@computer.b.value | @computer.ram[@operand].value)
...
class Operation::NORI < Operation
  def initialize(computer)
    ...
    @steps[1] = -> {
      result = ~(@computer.b.value | @computer.ram[@computer.pc.value].value)
      @computer.a.value = result
      @computer.c.value = 0
      @computer.z.value = result & 0x0f == 0 ? 1 : 0
    }
...
class Operation::ADD < Operation
  def initialize(computer)
    ...
    @steps[7] = -> {
      result = @computer.b.value + @computer.ram[@operand].value + @computer.c.value
      @computer.a.value = result
...
class Operation::ADDI < Operation
  def initialize(computer)
    ...
    @steps[1] = -> {
      result = @computer.b.value + @computer.ram[@computer.pc.value].value + @computer.c.value
      @computer.a.value = result
      @computer.c.value = result[4]
      @computer.z.value = result & 0x0f == 0 ? 1 : 0
    }
